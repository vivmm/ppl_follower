...
def simple_detect_bbox(img):
    ...
    lower_bound = np.array([25, 52, 72])  # red [136, 87, 111], green [25, 52, 72], blue [94, 80, 2]
    upper_bound = np.array([102, 255, 255])  # red [180, 255, 255], green [102, 255, 255], [120, 255, 255]
